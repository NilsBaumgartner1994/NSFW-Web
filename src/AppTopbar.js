...
import AppTopbarCurrentUser from "./AppTopbarCurrentUser";
...
export class AppTopbar extends Component {
    ...
    renderTemplates(toggleIndex){
        return(
            <li role="none" className="topbar-submenu">
                <button type="button" role="menuitem" onClick={(e) => this.toggleMenu(e, toggleIndex)} aria-haspopup className="p-link">Templates</button>
                <CSSTransition nodeRef={this.templatesOverlayRef} classNames="p-connected-overlay" timeout={{ enter: 120, exit: 100 }} in={this.state.activeMenuIndex === toggleIndex}
    ...
    renderResources(toggleIndex){
        return(
            <li role="none" className="topbar-submenu">
                <button type="button" role="menuitem" onClick={(e) => this.toggleMenu(e, toggleIndex)} aria-haspopup className="p-link">Resources</button>
                <CSSTransition nodeRef={this.resourcesOverlayRef} classNames="p-connected-overlay" timeout={{ enter: 120, exit: 100 }} in={this.state.activeMenuIndex === toggleIndex}
                               unmountOnExit onEntered={this.onMenuEnter}>
    ...
    renderVersions(toggleIndex){
        return(
            <li role="none" className="topbar-submenu">
                <button type="button" role="menuitem" onClick={(e) => this.toggleMenu(e, toggleIndex)} aria-haspopup className="p-link">v{this.version}</button>
                <CSSTransition nodeRef={this.versionsOverlayRef} classNames="p-connected-overlay" timeout={{ enter: 120, exit: 100 }} in={this.state.activeMenuIndex === toggleIndex}
                               unmountOnExit onEntered={this.onMenuEnter}>
    ...
    renderNews(toggleIndex){
        return(
            <li role="none" className="topbar-submenu">
                <button type="button" role="menuitem" onClick={(e) => this.toggleMenu(e, toggleIndex)} aria-haspopup className="p-link">
                            <span className="p-overlay-badge">
                                Notifications
                                <Badge severity="danger"></Badge>
                            </span>
                </button>
                <CSSTransition nodeRef={this.themesOverlayRef} classNames="p-connected-overlay" timeout={{ enter: 120, exit: 100 }} in={this.state.activeMenuIndex === toggleIndex}
                               unmountOnExit onEntered={this.onMenuEnter}>
                    <ul ref={this.themesOverlayRef} role="menu" aria-label="Themes">
                        <li role="none" className="topbar-submenu-header">Notifications</li>
                        ...
                        <li role="none" className="topbar-submenu-header">Messages</li>
                        <li role="none"><button type="button" className="p-link" onClick={e => this.onThemeChange(e, 'bootstrap4-light-blue')} role="menuitem"><img src="showcase/images/themes/bootstrap4-light-blue.svg" alt="Blue Light" /><span>Blue Light</span></button></li>
                        <li role="none"><button type="button" className="p-link" onClick={e => this.onThemeChange(e, 'bootstrap4-light-purple')} role="menuitem"><img src="showcase/images/themes/bootstrap4-light-purple.svg" alt="Purple Light" /><span>Purple Light</span></button></li>
                        <li role="none"><button type="button" className="p-link" onClick={e => this.onThemeChange(e, 'bootstrap4-dark-blue', true)} role="menuitem"><img src="showcase/images/themes/bootstrap4-dark-blue.svg" alt="Blue Dark" /><span>Blue Dark</span></button></li>
                        <li role="none"><button type="button" className="p-link" onClick={e => this.onThemeChange(e, 'bootstrap4-dark-purple', true)} role="menuitem"><img src="showcase/images/themes/bootstrap4-dark-purple.svg" alt="Purple Dark" /><span>Purple Dark</span></button></li>
    ...
    renderToggleMenu(toggleIndex, contentName){
        return(
            <li role="none" className="topbar-submenu">
                <button type="button" role="menuitem" onClick={(e) => this.toggleMenu(e, toggleIndex)} aria-haspopup className="p-link">
                            <span className="p-overlay-badge">
    ...
    renderThemes(toggleIndex){
        return(
            <li role="none" className="topbar-submenu">
                <button type="button" role="menuitem" onClick={(e) => this.toggleMenu(e, 1)} aria-haspopup className="p-link">
                            <span className="p-overlay-badge">
                                Themes
                                <Badge severity="danger"></Badge>
                            </span>
    ...
    renderGetStarted(toggleIndex){
        return (
            <li role="none">
                <Link to="/setup" role="menuitem" className="topbar-root-link" aria-haspopup={false} onClick={this.resetMenuActive.bind(this)}>Get Started</Link>
            </li>
        );
    }
    ...
    render() {
        return (
            <div className="layout-topbar">
                ...
                <button type="button" className="p-link menu-button" onClick={this.onMenuButtonClick.bind(this)} aria-haspopup aria-label="Menu">
