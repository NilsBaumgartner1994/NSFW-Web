...
export class Login extends Component {
    ...
    async loadInformations(){
        ...
        console.log("Load Informations; GetAuths");
        console.log(auths);
        let authSelectItems = this.getAuthSelectItems(auths);
        console.log(authSelectItems);
        ...
        console.log(selectedAuth);
        console.log("Load now Stored Credentials");
    ...
    async handleSubmitevents(event) {
        ...
        console.log("Sending Auth Object");
        ...
        if(RequestHelper.isSuccess(authAnswer)){
            console.log("AuthAnswer is Success");
            console.log("Get now Current User");
            let currentUser = await MyStorage.getCurrentUser();
